...
export default function Gallery() {
  return (
    <div className="py-10 w-full h-auto flex flex-col items-center justify-center ">
      ...
      <div className="flex flex-wrap justify-center gap-5 m-auto items-center justify-center mt-10 w-[90%] h-auto">
        <img src={honb} alt="Gallery Image" className="w-[20%] h-[300px]" />
        <img src={honb2} alt="Gallery Image" className="w-[20%] h-[300px]" />
        <img src={honb3} alt="Gallery Image" className="w-[20%] h-[300px]" />
        <img src={honb4} alt="Gallery Image" className="w-[20%] h-[300px]" />
        <img src={honb5} alt="Gallery Image" className="w-[21%] h-[300px]" />
        <img src={honb6} alt="Gallery Image" className="w-[20%] h-[300px]" />
        <img src={honb7} alt="Gallery Image" className="w-[20%] h-[300px]" />
      </div>
    </div>
  )
}